    ...
    <section className="py-20 bg-brand-off-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-brand-primary">Cost Savings vs Hotels</h4>
                    <p className="text-gray-600 text-sm">Up to 40% savings on extended stays compared to traditional hotels</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-brand-secondary rounded-full mt-2"></div>
                  <div>
                    <h4 className="font-semibold text-brand-primary">Tax Advantages</h4>
                    <p className="text-gray-600 text-sm">Proper documentation and invoicing for corporate tax benefits</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-brand-secondary rounded-full mt-2"></div>
                  <div>
                    <h4 className="font-semibold text-brand-primary">Employee Satisfaction</h4>
                    <p className="text-gray-600 text-sm">Home-like comfort improves productivity and job satisfaction</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-brand-secondary rounded-full mt-2"></div>
                  <div>
                    <h4 className="font-semibold text-brand-primary">Flexible Terms</h4>
                    <p className="text-gray-600 text-sm">Customizable contracts to match your business timeline</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-brand-light-grey rounded-xl p-6">
                <h4 className="font-bold text-brand-primary mb-4">Transportation Links</h4>
                <div className="grid grid-cols-2 gap-3">
                  {transportLinks.map((link, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <link.icon className="h-4 w-4 text-brand-secondary" />
                      <div>
                        <div className="text-sm font-medium text-brand-primary">{link.name}</div>
        ...
        <div className="text-center mt-12">
          <button className="bg-brand-secondary hover:bg-brand-secondary/90 text-white px-8 py-4 rounded-lg font-semibold flex items-center space-x-2 mx-auto transition-all duration-300 transform hover:scale-105">
